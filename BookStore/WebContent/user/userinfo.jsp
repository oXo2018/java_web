...
<body>
    ...
    <div class="container4">
    	<div class="register_box">
    			...
    			<div class="security">
    				<form action="user/updateUserSer" method="post">
    					<ul class="list">
    						<li>
    								<input id="J_euserName" class="long" readonly="readonly" name="username" value="${sessionScope.user.username}" type="text" />
    						...
    						<li>
    								<input id="J_euserName" class="long" name="password" value="${sessionScope.user.password}" type="text" />
    						...
    						<li>
    								<input id="J_euserName" class="long" name="address" value="${sessionScope.user.address}" type="text" />
